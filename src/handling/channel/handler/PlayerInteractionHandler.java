        ...
        switch (action) { // Mode
            ...
            case CHAT: {
                ...
                if (chr.getTrade() != null) {
                    ...
                    final IMaplePlayerShop ips = chr.getPlayerShop();
                    ips.getMessages().add(new Pair<String, Byte>(message, ips.getVisitorSlot(chr)));
...
//                    }
            ...
            case CLOSE_MERCHANT: {
                ...
                if (merchant != null && merchant.getShopType() == 1 && merchant.isOwner(chr) && merchant.isAvailable()) {
                    c.getSession().write(PlayerShopPacket.shopErrorMessage(0x15, 0));// 關閉窗口
