...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.sendSimple("Hello! I'm the #r#eAP Reset NPC#n#k. If you have voted on our site, you will get a point each time! I see you have #e#r" + cm.getPlayer().getVPoints() + "#n#k voting points! I can redeem your points a Full AP Reset! Would you like that?\r\n\r\n#b#L4#Reset ALL AP (DOES NOT reset HP or MP) - #r 50 Vote points #k#l#k");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var it;
