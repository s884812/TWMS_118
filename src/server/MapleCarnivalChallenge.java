    ...
    public static final String getJobNameById(int job) {
	    ...
	    case 1:
            ...
            case 500:
                return "Pirate";
            case 510:
                return GameConstants.GMS ? "Brawler" : "Infighter";
            case 511:
                return GameConstants.GMS ? "Marauder" : "Buccaneer";
            case 512:
                return GameConstants.GMS ? "Buccaneer" : "Viper";
            case 520:
                return "Gunslinger";
            case 521:
                return GameConstants.GMS ? "Outlaw" : "Valkyrie";
            case 522:
                return GameConstants.GMS ? "Corsair" : "Captain";
			case 501:
