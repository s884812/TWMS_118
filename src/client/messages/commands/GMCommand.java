...
import handling.login.AutoRegister;
...
public class GMCommand {
    ...
    public static class 獲得技能 extends GetSkill {
    ...
    public static class 獲得道具 extends GetItem {
    ...
    public static class GetItem extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (GameConstants.isPet(itemId)) {
                ...
                item.setGMLog(c.getPlayer().getName() + " 使用 !getitem");
                //}
    ...
    public static class AutoReg extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(0, "自動註冊狀態: " + (AutoRegister.autoRegister ? "開啟" : "關閉") + ".");
            System.out.println("自動註冊狀態: " + (AutoRegister.autoRegister ? "開啟" : "關閉") + ".");
            return 1;
        }
    }
}
