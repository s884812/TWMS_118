...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    ENRAGE(0x200000, 3),// 0x40000分身
    SHADOWPARTNERX(0x80000, 3),
    ...
    ENERGY_CHARGE(0x400, 4),
    DASH_SPEED(0x800, 4),
    DASH_JUMP(0x1000, 4),
    MONSTER_RIDING(0x2000, 4),
    SPEED_INFUSION(0x4000, 4),
    HOMING_BEACON(0x8000, 4),
    DEFAULT_BUFFSTAT(0x10000, 4),;
