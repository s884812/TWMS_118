                ...
                if (used) {
                    switch (apto) { // AP to
                        ...
                        case 8192: // mp
                            ...
                            if (GameConstants.isBeginnerJob(job)) { // Beginner
                                maxmp += 6;
                            } else if ((job >= 100 && job <= 132) || (job >= 1100 && job <= 1112) || (job >= 2100 && job <= 2112)) { // Warrior
                                maxmp += 2;
                            } else if ((job >= 200 && job <= 232) || (job >= 2200 && job <= 2218) || (job >= 3200 && job <= 3212)) { // Magician
                                ...
                                //    maxmp += improvingMaxMP.getEffect(improvingMaxMPLevel).getY() * 2;
                                //}
                            } else if ((job >= 300 && job <= 322) || (job >= 400 && job <= 434) || (job >= 3200 && job <= 3212) || (job >= 3500 && job <= 3512) || (job >= 1300 && job <= 1312) || (job >= 1400 && job <= 1412) || (job >= 2300 && job <= 2312)) { // Bowman
                                maxmp += 10;
                            } else if ((job >= 500 && job <= 532) || (job >= 1500 && job <= 1512)) { // Bowman
                                maxmp += 14;
                            } else { // GameMaster
                                maxmp += 6;
                            }
                    ...
                    switch (apfrom) { // AP from
                        ...
                        case 2048: // HP
                            ...
                            if (GameConstants.isBeginnerJob(job)) { // Beginner
                                ...
                                maxhp -= 42;
                            } else if (((job >= 100 && job <= 132) || job >= 1100 && job <= 1112) || (job >= 2100 && job <= 2112)) { // Soul Master
                                maxhp -= 54;
                            } else { // GameMaster
                                maxhp -= 12;
                            }
                        ...
                        case 8192: // MP
                            ...
                            if (GameConstants.isBeginnerJob(job)) { // Beginner
                                ...
                                maxmp -= 4;
                            } else if ((job >= 200 && job <= 232) || (job >= 1200 && job <= 1212) || (job >= 2200 && job <= 2218)) { // Magician
                                maxmp -= 30;
                            } else if ((job >= 300 && job <= 322) || (job >= 400 && job <= 434) || (job >= 1300 && job <= 1312) || (job >= 1400 && job <= 1412) || (job >= 3300 && job <= 3312) || (job >= 3500 && job <= 3512) || (job >= 2300 && job <= 2312)) { // Pirate, Bowman. Thief
                                maxmp -= 12;
            ...
            case 5152107: {
                ...
                if (color >= 0) {
                    if (changeFace(c.getPlayer(), color)) {
                        ...
                        c.getPlayer().dropMessage(1, "当前脸型不支持这个颜色的隐形眼镜。");
                    }
                } else {
                    c.getPlayer().dropMessage(1, "使用一次性隐形眼镜出现错误。");
                }
                break;
            }
