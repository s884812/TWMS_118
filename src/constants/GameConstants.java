...
//  public static final int[] blockedSkills = {23101003, 4321000, 3120006, 3110005, 13101006, 3211005, 4120010, 2220010, 2320011, 2120010};
    public static final String[] RESERVED = {"Rental", "Donor", "管", "理", "员"};
    ...
    public static Double maxViewRangeSq() {
        return 1366 * 768d * 2d /*Double.POSITIVE_INFINITY*/;
    }

    public static Double maxViewRangeSq_Half() {
        return 1366 * 768d /*Double.POSITIVE_INFINITY*/;
    }

    /*public static int maxViewRangeSq() {
        return 1024 * 768; // 1024 * 768 Integer.MAX_VALUE
    }
    
    public static int maxViewRangeSq_Half() {
        return 800 * 800; // 800 * 800 Integer.MAX_VALUE
    }*/
    ...
    public static int[] blockedMaps = {180000001, 180000002, 109050000, 280030000, 240060200, 280090000, 280030001, 240060201, 950101100, 950101010, 222010401};
    ...
    public static boolean isFishingMap(int mapid) {
        return mapid == 749050500 || mapid == 749050501 || mapid == 749050502 || mapid == 970020000 || mapid == 970020005 || mapid == 910000000;
    }
