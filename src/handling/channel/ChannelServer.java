...
public class ChannelServer {
    ...
    public final void shutdown() {
        ...
        broadcastPacket(MaplePacketCreator.serverNotice(0, "遊戲伺服器即將關閉維護..."));
        // dc all clients by hand so we get sessionClosed...
        shutdown = true;

        System.out.println("頻道 " + channel + "， 正在儲存所有玩家數據...");
    ...
    public final void setShutdown() {
        this.shutdown = true;
        System.out.println("頻道 " + channel + " 正在關閉和儲存精靈商人數據信息...");
    }

    public final void setFinishShutdown() {
        this.finishedShutdown = true;
        System.out.println("頻道 " + channel + " 已關閉完成。");
    }
