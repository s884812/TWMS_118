...
public class AdminCommand {
    ...
    public static class 關閉伺服器 extends Shutdown {
    }
    ...
    public static class Shutdown extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (t == null || !t.isAlive()) {
                ...
                c.getPlayer().dropMessage(6, "關閉進程正在進行或者關閉已完成，請稍後。");
            }
            return 1;
        }
    }

    public static class 關閉伺服器時間 extends ShutdownTime {
    }
    ...
    public static class ShutdownTime extends Shutdown {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, "伺服器將在 " + minutesLeft + " 分鐘後關閉。");
            if (ts == null && (t == null || !t.isAlive())) {
                ...
                ts = EventTimer.getInstance().register(new Runnable() {
                    ...
                    public void run() {
                        ...
                        World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(0, "伺服器將在" + minutesLeft + "分鐘後進行停機維護，請及時安全下線，以免造成不必要的損失。"));
                        minutesLeft--;
                    }
                }, 60000);
            } else {
