...
public class PetPacket {
    ...
    public static final byte[] movePet(final int cid, final int pid, final byte slot, Point startPos, final List<LifeMovementFragment> moves) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] showPetUpdate(final MapleCharacter chr, final MaplePet pet) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
